...
def generate_pdf(modeladmin, request, queryset):
    ...
    p.drawImage("static/brand/logo.png", 100, 760, width=75, height=75, mask='auto')
    p.drawImage("static/brand/Flag_of_Turkmenistan.svg.png", 410, 770, width=90, height=60, mask='auto')
